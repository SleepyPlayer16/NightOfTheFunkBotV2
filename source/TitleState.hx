...
class TitleState extends MusicBeatState
{
	...
	override function beatHit()
	{
		...
		switch (curBeat)
		{
			...
			case 5:
				if (Main.watermarks)
					createCoolText(['stardust tunes', 'abigail blythe', 'justrichard', 'paperkitty']);
			case 7:
				if (Main.watermarks)
					addMoreText('Special thanks to em');
				else
				{
			...
			// credTextShit.text += '\nNight';
			case 15:
				addMoreText('Funky Bot'); // credTextShit.text += '\nFunkin';
